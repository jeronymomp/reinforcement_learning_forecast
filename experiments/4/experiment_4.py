...
This is the code for the Experiment number 4 of the pdf "Proposed SImulation Experiment"
"""
...
result_path = '/data/keeling/a/jeronymo/reinforcement_learning_forecast/experiments/4'
